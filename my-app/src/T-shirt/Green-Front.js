...
import MenuW from "../Components/Green/MenuGreen";
import Upload from "../Upload/Upload1";
import FieldFull from "../Asset/T-shirt/Field-Full-White.png";
import "../Components/Products.css";

function GreenFront({ uploadedImageFront, setUploadedImageFront, setImageStyleOptionFront, onImageUpload }) {
        ...
        <div className="Frame1">
          ...
          <div className="Box">
            ...
            <div className="CustomFront">
              <img id="MockupFront1" src="/T-Shirt-Green.png" alt="Mockup" />
              {uploadedImageFront ? (
...
export default connect(mapStateToPropsFront, mapDispatchToPropsFront)(GreenFront);