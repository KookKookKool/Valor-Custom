          ...
          <div className="Box">
            ...
            <div className="FieldCustom">
              <div className="CustomFront">
                <img id="MockupFront1" src="/T-Shirt-Navy-back.png" alt="Mockup" />
                {uploadedImageBack ? (
                  <img
                    id="FieldUpload"
...
export default connect(mapStateToPropsBack, mapDispatchToPropsBack)(NavyBack);
