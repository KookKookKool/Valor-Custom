...
import MenuWhiteRight from "../Components/Black/MenuBlackRight";
import Upload from "../Upload/Upload1";
import FieldFull from "../Asset/T-shirt/Field-Arm-White.png"; 

function BlackRight({ uploadedImageRight, setUploadedImageRight, setImageStyleOptionRight }) {
          ...
          <div className="Box">
            ...
            <div className="FieldCustom">
              <div className="CustomFront">
                <img id="MockupFront1" src="/shirt-Black-side.png" alt="Mockup" style={{ mixBlendMode: 'multiply', filter: 'contrast(1)' }}/>
                {uploadedImageRight ? (
                  <img
                    id="FieldUploadRight"
...
export default connect(mapStateToPropsRight, mapDispatchToPropsRight)(BlackRight);